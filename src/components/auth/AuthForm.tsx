  ...
  return (
    <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold mb-6 text-center">
        {mode === 'login' ? 'Entrar no NeoSapiens' : 'Criar Conta NeoSapiens'}
      </h2>
      ...
      <button
        ...
        className="w-full mb-4 bg-white border-2 border-gray-300 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 flex items-center justify-center gap-3 font-medium transition-colors"
      >
        {googleLoading ? (
      ...
      <div className="relative mb-4">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-white text-gray-500">ou use email</span>
        </div>
      </div>
